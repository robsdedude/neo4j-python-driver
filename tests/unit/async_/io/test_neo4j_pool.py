...
from neo4j._async.addressing import _AsyncMultiAddress
...
POOL_ADDRESS = _AsyncMultiAddress("neo4j", (ROUTER1_ADDRESS,))
...
async def test__acquire_new_later_with_room(opener):
    ...
    pool = AsyncNeo4jPool(opener, config, WorkspaceConfig(), POOL_ADDRESS)
