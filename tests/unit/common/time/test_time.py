...
def make_reduce_times():
    return (
        ...
        Time(
            13, 34, 56, 789000001, tzinfo=datetime_timezone(timedelta(hours=1))
        ),
...
class TestTime:
    ...
    @pytest.mark.parametrize(
        ("t", "expected"),
        (
            (Time(12, 34, 56, 789123456), "12:34:56.789123456"),
            (time(12, 34, 56, 789123), "12:34:56.789123"),
            (Time(12, 34, 56, 789000000), "12:34:56.789000000"),
            (time(12, 34, 56, 789000), "12:34:56.789000"),
            (Time(12, 34, 56, 789), "12:34:56.000000789"),
