...
class AsyncGraphDatabase:
        ...
        def driver(
            ...
            **config,
            ...
            if isinstance(uri, _MultiAddress):
                ...
                multi_addr = _MultiAddress._from_url(parsed._replace(query=""))
    ...
    # TODO: 7.0 - remove this unused, undocumented method
    @classmethod
    @deprecated(
    ...
    def bolt_driver(cls, target, **config):
        ...
        """
        return cls._bolt_driver(_MultiAddress("bolt", (target,)), **config)
    ...
    def _bolt_driver(cls, multi_addr, **config):
        ...
        try:
            return AsyncBoltDriver._open(multi_addr, **config)
    ...
    def _neo4j_driver(cls, multi_addr, **config):
        ...
        try:
            return AsyncNeo4jDriver._open(multi_addr, **config)
        except (BoltHandshakeError, BoltSecurityError) as error:
            from ..exceptions import ServiceUnavailable
...
class _Direct:
    ...
    # TODO: 7.0 - remove this undocumented property
    @property
...
class AsyncBoltDriver(_Direct, AsyncDriver):
    ...
    def _open(cls, multi_addr, **config):
        ...
        addresses = multi_addr.addresses
...
class AsyncNeo4jDriver(_Routing, AsyncDriver):
    ...
    def __init__(self, pool, default_workspace_config):
        _Routing.__init__(self, list(pool.multi_addr.addresses))
        AsyncDriver.__init__(self, pool, default_workspace_config)
