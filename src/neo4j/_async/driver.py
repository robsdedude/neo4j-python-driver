...
from .addressing import _AsyncMultiAddress
...
if t.TYPE_CHECKING:
    ...
    from .addressing import AsyncMultiAddress
...
class AsyncGraphDatabase:
        ...
        def driver(
            ...
            **config,
            ...
            :param config: driver configuration key-word arguments,
                ...
                key-word arguments.
            """
            if isinstance(uri, _AsyncMultiAddress):
                multi_addr = uri
            else:
                ...
                multi_addr = _AsyncMultiAddress._from_url(
    ...
    def bolt_driver(cls, target, **config):
        ...
        return cls._bolt_driver(
            _AsyncMultiAddress("bolt", (target,)), **config
        )
