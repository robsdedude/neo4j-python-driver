...
from ...._codec.hydration.bolt import (
...
class AsyncBolt(AsyncConnection):
    """
    ...
    HYDRATION_HANDLER_CLS: type[HydrationHandlerBoltBase] = (
    ...
    async def fetch_message(self):
        ...
        await self._process_message(tag, fields)
        self.idle_since = monotonic()
